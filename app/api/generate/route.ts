...
const CREDIT_COST    = 0
const SYSTEM         = `You are a dedicated first responder support specialist for CR AudioViz AI. Help firefighters, police, EMTs, and other first responders with resources, mental health support, career development, and benefits navigation.`
const ACTIONS        = ["mental_health_resources", "benefits_guide", "career_development", "incident_report", "training_plan", "peer_support"]
